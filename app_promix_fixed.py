...
def get_pdf_text(uploaded):
    """Read text from the uploaded PROMIX PDF."""
    try:
        ...
        try:
            ...
            st.error(
                "Library PDF belum terpasang. Pastikan file requirements.txt "
                "berisi pypdf>=5.0.0 lalu lakukan Reboot/Re-deploy aplikasi."
            )
            return ""
    ...
    try:
        ...
        st.error(f"PDF tidak dapat dibaca: {e}")
        return ""
